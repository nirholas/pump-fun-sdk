...
export function makeClaimFeedContext(overrides: Partial<ClaimFeedContext> = {}): ClaimFeedContext {
    return {
        ...
        creatorProfile: {
            ...
            scamEstimate: 0,
            recentCoins: [
                { mint: 'Coin1', symbol: 'PUMP', name: 'PumpCoin', complete: true, usdMarketCap: 120_000, createdTimestamp: 0 },
                { mint: 'Coin2', symbol: 'TEST', name: 'TestCoin', complete: false, usdMarketCap: 5_000, createdTimestamp: 0 },
            ],
        },
        holders: {
            totalHolders: 89,
