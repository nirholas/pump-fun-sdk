...
# overriding it here the same way. It is also the sibling of
# channel-bot/recover-env.sh; the two bots share no token, channel or service,
# only the shape of this script.
#
